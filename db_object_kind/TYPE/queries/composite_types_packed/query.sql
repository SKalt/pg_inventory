...
INNER JOIN pg_catalog.pg_namespace AS ns -- https://www.postgresql.org/docs/current/catalog-pg-namespace.html
  ON type_.typtype = 'c' AND type_.typnamespace = ns.oid
...
INNER JOIN pg_catalog.pg_class AS relation -- https://www.postgresql.org/docs/current/catalog-pg-class.html
  ON type_.typrelid = relation.oid
